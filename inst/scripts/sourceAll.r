...
## sourceDir("c:/HOME/rmh/HH-R.package/HH/inst/scripts", chdir=TRUE, echo=TRUE) ## not working yet


## this line sources all r files into R for the 18 chapters of the HH book
path <- "c:/HOME/rmh/HH-R.package/HH/inst/scripts"
...
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch02-data.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch03-conc.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch04-grap.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch05-iinf.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch06-oway.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch07-mcomp.r"                , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch08-rega.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch09-regb.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch10-regbb.r"                , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch11-regc.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch12-rhiz-bwplot-alternate.r", chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch12-tway.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch13-dsgn.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch14-apple3.r"               , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch14-dsgntwo.r"              , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch15-twtb.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch16-npar.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch17-logi.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)
source("c:/HOME/rmh/HH-R.package/HH/inst/scripts/Ch18-tser.r"                 , chdir=TRUE, echo=TRUE, print.eval=TRUE)       ##  options(old.HH.ROOT.DIR)
